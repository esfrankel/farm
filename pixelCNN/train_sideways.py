...
load_params = './models/sideways_pcnn_lr:0.00020_nr-resnet5_nr-filters160_4.pth' # restore training from previous model checkpoint, default is None
...
np.random.seed(seed)
model_name = 'sideways_pcnn_lr:{:.5f}_nr-resnet{}_nr-filters{}'.format(lr, nr_resnet, nr_filters)
...
model = PixelCNNSideways(nr_resnet=nr_resnet, nr_filters=nr_filters, 
